      ...
      <ul class="nav-links">
        ...
        <li>
         <a href="exams.php">
            ...
            <span class="links_name">Challenge</span>
          </a>
        </li>
        <li>
          <a href="results.php">
    ...
    <div class="home-content">
      ...
      <div class="stat-boxes">
        <div class="recent-stat box" style="width:100%">
          ...
          <h4>Q5. How to conduct challenges ?</h4>
          <p>Ans: Navigate to the challenges tab by clicking on the challenges button from the left navigation bar. New challenge can be added and old ones can also be deleted from here according to your preference. After adding a challenge, click on the edit icon to add questions.</p><br>
          <p><b>Important notice:</b> Once the challenge questions have been added once, do not try to update the questions. It can cause error in the functioning of the website. Updating the existing questions feature will be introduced in the future updates.</p>
