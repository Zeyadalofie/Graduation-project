    ...
    <div class="home-content">
      ...
      <div class="stat-boxes">
        <div class="recent-stat box" style="width:100%">
          ...
          <h4>Q4. How to attempt challenges ?</h4>
          <p>Ans: Navigate to the challenges tab by clicking on the challenges button from the left navigation bar. Challenges can be attempted from here.</p><br>
