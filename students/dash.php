    ...
    <div class="overview-boxes">
        <div class="box">
          <div class="right-side">
            <div class="box-topic">Challenges</div>
            ...
            <div class="brief">
              <span class="text">Total number of challenges</span>
            </div>
          </div>
        ...
        <div class="box">
          <div class="right-side">
            ...
            <div class="brief">
              <span class="text">Total number of attempted challenges</span>
            </div>
          </div>
      ...
      <div class="stat-boxes">
        <div class="recent-stat box" style="width:100%;">
          ...
          <div class="stat-details">
            <ul class="details">
              <li>You are only allowed to start the test at the prescribed time. The timer will start from the current time irrespective of when you start the challenge and end when the given time is up.</li><br>
              <li>You can see the history of test taken and scores in the Results section</li><br>
              <li>To start the test, click on 'Start' button in the challenge section.</li><br>
